...
This script reads cleaned text files from backend/data/rag/processed/ directory,
...
Requires:
    ...
    - Cleaned text files in backend/data/rag/processed/ directory (.txt files)
    - Onboarding questions seeded (python scripts/dev/seed_onboarding_questions.py)
...
async def main() -> None:
    ...
    texts_dir = Path("backend/data/rag/processed")
